...
public class Bangalore extends Fragment implements CityAdapter.PlayPauseClick {
    ...
    private void WeatherLoaded() {
        ...
        url_weather = Constants.WEATHER_URL+"?q=Bangalore,in"+"&APPID=c22ce917e53c30a79860941c8cf54484";
                        ...
                        if(response!=null) {
                            ...
                            try {
                                ...
                                if(!arrayList.isEmpty()) {
                                    ...
                                    cityAdapter = new CityAdapter(getContext(), arrayList);
                                    recycler_view.setAdapter(cityAdapter);
                                    cityAdapter.setPlayPauseClickListener(Bangalore.this);
    ...
    public void imageButtonOnClick() {
        Log.i("imageButtonOnClick","2222Test is done=======================================================================>");
