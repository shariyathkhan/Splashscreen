...
public class Mumbai extends Fragment implements CityAdapter.PlayPauseClick {
    ...
    private void WeatherLoaded() {
        ...
        url_weather = Constants.WEATHER_URL+"?q=Mumbai,in"+"&APPID=c22ce917e53c30a79860941c8cf54484";
                        ...
                        if(response!=null) {
                            ...
                            try {
                                ...
                                if(!arrayList.isEmpty()) {
                                    ...
                                    cityAdapter = new CityAdapter(getContext(), arrayList);
                                    recycler_view.setAdapter(cityAdapter);
                                    cityAdapter.setPlayPauseClickListener(Mumbai.this);
    ...
    public void imageButtonOnClick() {
        Log.i("imageButtonOnClick","3333Test is done=======================================================================>");
